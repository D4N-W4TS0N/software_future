...
Andrej Karpathy, a prominent figure in the AI community with previous roles at OpenAI and Tesla, has proposed the concept of "Software Engineering 3.0" to describe the future of software development in an AI-enabled world. The concept (and those before it) are explained below:
...
This last shift has been enabled by large language models (LLMs), which are neural networks trained on vast amounts of data (containing natural language and source code) to learn patterns and relationships. As a result, they are now capable of producing syntactically correct and often functional code based on natural language prompts - a significant step onwards from just writing, now to full code generation. However, while models may become more proficient at generating code than humans, I can't see humans being removed from the process entirely, though their function will obviously change. In terms of what the code generation process might look like, my opinion is in the next section.
